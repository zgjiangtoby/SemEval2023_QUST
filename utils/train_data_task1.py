...
all_dev_ids = []
for l in lan:
    filenames = glob.glob('../original_data_v4/data/{}/train-articles-subtask-1/*.txt'.format(l))
    dev_filenames = glob.glob('../original_data_v4/data/{}/dev-articles-subtask-1/*.txt'.format(l))
    # print(len(filenames))
    all_subtask_names.extend(filenames)
    all_dev_names.extend(dev_filenames)

    labels = glob.glob('../original_data_v4/data/{}/train-labels-subtask-1.txt'.format(l))
    dev_labels = glob.glob('../original_data_v4/data/{}/dev-labels-subtask-1.txt'.format(l))
...
print(len(output))
#
with open("../train-dev-articles-subtask-1.json", 'w') as ouf:
